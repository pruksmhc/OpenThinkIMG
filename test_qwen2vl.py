...
from tool_server.tf_eval.tool_inferencer.base_inferencer import BaseToolInferencer
...
def main():
    ...
    qwen = VllmModels(pretrained=args.model, limit_mm_per_prompt=args.max_rounds)
    ...
    infer = BaseToolInferencer(
        ...
        batch_size=1,
        model_mode="general",
        max_rounds=args.max_rounds,            # important: finish immediately; no tool loop
        stop_token="<stop>",
