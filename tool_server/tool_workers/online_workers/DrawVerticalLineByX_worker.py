...
def DrawVerticalLine(image, point_coords=None):
...
class DrawVerticalLineToolWorker(BaseToolWorker):
    def __init__(self, 
                 controller_addr, 
                 worker_addr = "auto",
                 worker_id = worker_id, 
    ...
    def generate(self, params):
        ...
        try:
            ...
            edited_img = DrawVerticalLine(img, point_coords=points)
...
if __name__ == "__main__":
    ...
    worker = DrawVerticalLineToolWorker(
