...
commands=(
  ...
  "python ../../online_workers/crop_worker.py --host 0.0.0.0 --port 20009 --controller-address http://127.0.0.1:20001"
  "python ../../online_workers/grounding_dino_worker.py --host 0.0.0.0 --port 20002 --controller-address http://127.0.0.1:20001 --model-path ~/weights/groundingdino_swint_ogc.pth --model-config ~/weights/GroundingDINO_SwinT_OGC.py"
